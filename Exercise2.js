...
function exercise1(num1) {
  ...
  console.log( exercise3(1000394));
  console.log( exercise3(-98));
  ...
  console.log(exercise4(4, 4))
  console.log(exercise4(4, "four"))
  console.log(exercise4(4, 100))
  ...
  console.log(exercise4(true, 1<3<3));
